...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Gustavo Araujo Santos"
  # spec.authors            = { "Gustavo Araujo Santos" => "gustavoaraujo600@hotmail.com" }
  # spec.social_media_url   = "https://twitter.com/Gustavo Araujo Santos"
